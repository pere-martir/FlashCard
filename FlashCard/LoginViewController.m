...
@synthesize welcomeLabel, delegate = _delegate;
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (username != nil && [username length] > 0) {
        logInViewController.logInView.usernameField.text = username;
    }
    NSString* password = [defaults stringForKey:@"password"];
    if (password != nil && [password length] > 0) {
        logInViewController.logInView.passwordField.text = password;
    }
